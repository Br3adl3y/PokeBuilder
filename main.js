...
class PokeApp {
    constructor() {
        ...
        this.pveManager = new PvEManager(this);                     // PvE raid/rocket manager
    ...
    async render() {
        ...
        } else if (this.currentView === 'pve') {
            app.innerHTML = this.pveManager.render();
    ...
    attachEventListeners() {
        ...
        // If we're in PvE view, attach its specific listeners
        if (this.currentView === 'pve') {
            this.pveManager.attachEventListeners();
        }
