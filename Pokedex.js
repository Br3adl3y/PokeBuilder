                            ...
                            ${chainPokemon.map(mon => `
                                <div class="iv-row">
                                    ...
                                    <div class="iv-buttons">
                                        <button class="iv-btn px-2 py-1 rounded-full bg-yellow-300 text-yellow-900 font-semibold hover:bg-yellow-400 transition text-xs" data-action="iv-spread" data-league="little" data-pokemon="${mon.id}" data-full="Little" data-short="L"><span class="hidden xs:inline">Little</span><span class="inline xs:hidden">L</span></button>
                                        <button class="iv-btn px-2 py-1 rounded-full bg-cyan-400 text-cyan-900 font-semibold hover:bg-cyan-500 transition text-xs" data-action="iv-spread" data-league="great" data-pokemon="${mon.id}" data-full="Great" data-short="G"><span class="hidden xs:inline">Great</span><span class="inline xs:hidden">G</span></button>
                                        <button class="iv-btn px-2 py-1 rounded-full bg-purple-500 text-white font-semibold hover:bg-purple-600 transition text-xs" data-action="iv-spread" data-league="ultra" data-pokemon="${mon.id}" data-full="Ultra" data-short="U"><span class="hidden xs:inline">Ultra</span><span class="inline xs:hidden">U</span></button>
                                    </div>
                                </div>
                            `).join('')}
                        </div>
